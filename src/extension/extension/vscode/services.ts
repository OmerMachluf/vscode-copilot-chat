...
import { IOrchestratorPermissionService, OrchestratorPermissionService } from '../../orchestrator/orchestratorPermissions';
...
export function registerServices(builder: IInstantiationServiceBuilder, extensionContext: ExtensionContext): void {
	...
	builder.define(IOrchestratorPermissionService, new SyncDescriptor(OrchestratorPermissionService));
}
